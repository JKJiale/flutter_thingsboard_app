...
mixin DevicesBase on EntitiesBase<EntityData, EntityDataQuery> {
  @override
  String get title => '设备列表'; //Devices

  @override
  String get noItemsFoundText => '未查询到设备'; //No devices found
    ...
    if (profile.defaultDashboardId != null) {
      ...
      if (tbClient.isTenantAdmin()) {
        showWarnNotification(
            '请在设备配置文件中配置移动仪表盘!'); //Mobile dashboard should be configured in device profile!
      }
    }
  }
